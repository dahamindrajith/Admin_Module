<%-- 
    Document   : new_reocrd
    Created on : Jul 21, 2022, 10:09:36 AM
    Author     : MBSL15135
--%>

<%@page    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<div id="newAddDesignationModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">      
    <div class=" modal-dialog modal-lg " cg-busy="createDesignBusy">
                                            ...
                                            <div class="row col-md-12">
                                                <div class="col-md-12" >
                                                    ...
                                                    <md-input-container class="md-block">
                                                        ...
                                                        <input ng-model="createDesignation.desigType" name="desigType">
                                                    </md-input-container>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer text-right ">
                            <div class="mt-5 btn-group">    
                                <div class="text-start me-3">
                                    <button type="button" style="position: relative;" class="btn btn-danger btn-sm" ng-click="createDesig(false)">No</button>
                                </div>
                                <div class="text-end">
                                    <button type="button" style="position: relative;" class="btn btn-success btn-sm" ng-click="createDesig(true)">Yes</button>
                                </div>
                            </div>
                        </div>
                    </div>
