<%-- 
    Document   : new_record1_update
    Created on : Aug 25, 2022, 4:33:26 PM
    Author     : MBSL2523
--%>
...
<div id="newUpdateUserModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">      
                                            ...
                                            <div class="row col-md-12">
                                                <div class="col-md-6" >
                                                    ...
                                                    <md-input-container class="md-block">
                                                        ...
                                                        <input type="text" class="form-control" ng-model="user.rqstId" data-toggle="modal" ng-disabled="true" >
                                                    </md-input-container>
                                                    ...
                                                    <md-input-container class="md-block">
                                                        ...
                                                        <input ng-model="user.epfNo" name="userName" class="form-control" ng-disabled="true">
                                                    </md-input-container>
                                                ...
                                                <div class="col-md-6" >
                                                    ...
                                                    <div class="pull-right mt-5 btn-group"">
                                                        <div class="text-start me-3">
                                                            ...
                                                            <button class="btn btn-success btn-sm form-control" style="position: relative;" ng-disabled="regForm.$invalid" ng-click="showSaveDislog(2)">Update</button>  
                                                        </div>
                                                        <div class="text-end">
                                                            <button class="form-control btn-danger btn btn-sm form-control" style="position: relative;" ng-click="closeModel(2)">Cancel</button>
                                                        </div>
                                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer text-right ">
                            <div class="mt-5 btn-group">    
                                <div class="text-start me-3">
                                    <button type="button" style="position: relative;" class="btn btn-danger btn-sm form-control" ng-click="updateUser(false)">No</button>
                                </div>
                                <div class="text-end">
                                    <button type="button" style="position: relative;" class="btn btn-success btn-sm form-control" ng-click="updateUser(user.epfNo)">Yes</button>
                                </div>
                            </div>
                        </div>
                    </div>
