...
<!DOCTYPE html>
<div id="approveInfoUserCreate" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">      
                                        ...
                                        <div class="card card-body padding-left-3-present padding-right-none padding-top-none margin-bottom-1-present">
                                            <div class="row col-md-12">
                                                ...
                                                <md-input-container class="md-block">
                                                    ...
                                                    <input class="text-center" ng-model="user.fullName" name="profileName" ng-disabled="true">
                                                </md-input-container>
                                            </div>
                                        </div>
                                    </div>
