<%-- 
    Document   : new_record_region
    Created on : Dec 22, 2022, 2:41:34 PM
    Author     : MBSL2523
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<div id="newReagionAccessConfig" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">      
...
<!--                                                <md-input-container class="md-block col-md-6">
                                                        <label class="control-label padding-left-none padding-right-none  margin-top-1-present">Region Office</label>
        
                                                        <select class="col-md-6 pull-right" ng-model="userAccess.branchOrDept"> 
                                                ...
                                                <div class="pull-right mt-5 btn-group"">
                                                    <div class="text-start me-3">
                                                        ...
                                                        <button class="btn btn-success btn-sm" type="submit" style="position: relative;" ng-click="showSaveDislog(3)">Confirm</button>  
                                                        </div>
                                                    <div class="text-end">
                                                            <button class="form-control btn-danger btn btn-sm" style="position: relative;" ng-click="closeMdel(7)">Cancel</button>
                                                        </div>
                                                </div>
                ...
                <div class="modal fade" id="addRegTypModal" role="dialog" data-keyboard="false" data-backdrop="static">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer text-right ">
                            <div class="mt-5 btn-group">    
                                <div class="text-start me-3">
                                    <button type="button" style="position: relative;" class="btn btn-danger btn-sm form-control" ng-click="accessConfig('region',false)">No</button>
                                </div>
                                <div class="text-end">
                                    <button type="button" style="position: relative;" class="btn btn-success btn-sm form-control" ng-click="accessConfig('region',true)">Yes</button>
                                </div>
                            </div>
                        </div>
                    </div>
