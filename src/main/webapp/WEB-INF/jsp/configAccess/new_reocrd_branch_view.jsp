<%-- 
    Document   : new_reocrd_profile_view
    Created on : Nov 10, 2022, 11:48:38 AM
    Author     : MBSL2523
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<div id="newBranchAccessView" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">      
                                        ...
                                        <div class="card card-body padding-left-3-present padding-right-none padding-top-none margin-bottom-1-present">
                                            ...
                                            <div class="col-md-12" >
                                                ...
                                                <div class="pull-right mt-5 btn-group"">
                                                    <div class="text-end">
                                                            <button class="form-control btn-danger btn btn-sm" style="position: relative;" ng-click="closeMdel(3)">Cancel</button>
                                                        </div>
                                                </div>
