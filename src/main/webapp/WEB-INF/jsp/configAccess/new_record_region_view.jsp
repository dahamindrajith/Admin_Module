<%-- 
    Document   : new_record_region_view
    Created on : Dec 23, 2022, 10:39:14 AM
    Author     : MBSL2523
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<div id="newRegionView" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">      
                                            ...
                                            <div class="row col-md-12">
                                                <div class="col-md-12" >
                                                    ...
                                                    <div class="pull-right mt-5 btn-group"">
                                                        <div class="text-end">
                                                            <button class="form-control btn-danger btn btn-sm" style="position: relative;" ng-click="closeMdel(8)">Cancel</button>
                                                        </div>
                                                    </div>
