<%-- 
    Document   : new_reocrd
    Created on : Jul 21, 2022, 10:14:07 AM
    Author     : MBSL15135
--%>
...
<!DOCTYPE html>
<div id="newTransModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">      
                                            ...
                                            <div class="row col-md-12">
                                                <div class="col-md-6" >
                                                    ...
                                                    <div class="row col-md-12">
                                                        ...
                                                        <div class="col-md-6" >
                                                            ...
                                                            <md-input-container class="md-block">
                                                                ...
                                                                <label>User ID</label>
                                                                <input ng-model="transferUser.epfNo" name="epfNo">
                                                            </md-input-container>

                                                        </div>

                                                        <div class="col-md-6">
                                                            <button class="btnadd btn-success form-control btn-sm" style="position: relative;" data-bs-toggle="modal" ng-click="getListTransferById(transferUser.epfNo)">Select</button>
                                                        </div>
                                                    ...
                                                    <!--                                                    <md-input-container class="md-block">
                                                                                                            <label>User ID</label>
                                                                                                            <md-icon md-svg-src="img/svgIcons/user-svgrepo-com.svg" class="name"></md-icon>
                                                                                                            <input required ng-model="'MBSL'+transferUser.epfNo" name="userName" ng-disabled="true">
                                                ...
                                                <div class="col-md-6" >
                                                    ...
                                                    <div class="pull-right mt-5 btn-group"">
                                                        <div class="text-start me-3">
                                                            ...
                                                            <button class="btn btn-success btn-sm" style="position: relative;" ng-click="showSaveDislogTrans(1)">Save</button>  
                                                        </div>
                                                        <div class="text-end">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer text-right ">
                            <div class="mt-5 btn-group">    
                                <div class="text-start me-3">
                                    <button type="button" style="position: relative;" class="btn btn-danger btn-sm" ng-click="userTransfer(false)">No</button>
                                </div>
                                <div class="text-end">
                                    <button type="button" style="position: relative;" class="btn btn-success btn-sm" ng-click="userTransfer(transferUser.epfNo)">Yes</button>
                                </div>
                            </div>
                        </div>
                    </div>
