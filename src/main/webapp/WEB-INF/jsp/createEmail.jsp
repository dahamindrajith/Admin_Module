<%-- 
    ...
    Created on : Feb 7, 2023, 9:05:20 AM
    Author     : MBSL2523
--%>
...
<html ng-app="main">
    ...
    <div class="content-wrapper" ng-controller="emailCreate">
        <%@include file="../jsp/createEmail/new_record_view.jsp" %>
        ...
        <!-- Main content -->
        <section class="content" ng-init = "getEmailToCreate();" cg-busy="createEmailBusy">
                                        ...
                                        <table class="table table-striped table-hover table-bordered table-responsive" style="position: relative; font-size:15px;">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="availableData in assignData|filter:availableData">
                                                    ...
                                                    <td >{{availableData.emailAddress}}</td>
                                                    <td class="col-1"><div class="text-center">
                                                            <button class="btn btn-success btn-sm form-control" style="position: relative;" ng-click="getDataByRqstId(availableData.epfNo)" data-bs-toggle="modal" data-bs-target="#createEmail">View</button>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <script src="js/app/emailCreate.js?v=0.004"></script>
